...
%py3_shebang_fix \
    ...
    %{buildroot}%{_datadir}/rhc-worker-playbook/ansible/collections/ansible_collections/community/general/tests/utils/clean-aliases-skips \
    %{buildroot}%{_datadir}/rhc-worker-playbook/ansible/collections/ansible_collections/community/general/tests/integration/targets/django_command/files/base_test/1045-single-app-project/single_app_project/*.py \
    %{buildroot}%{_datadir}/rhc-worker-playbook/ansible/collections/ansible_collections/community/general/tests/integration/targets/django_command/files/base_test/simple_project/p1/*.py \
...
* Wed Jul 15 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.10-1
- Update rhc-worker-playbook to 0.2.10

* Mon May 11 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.9-1
- Update to 0.2.9

* Tue May 05 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.8-1
- Update to 0.2.8

* Mon Apr 27 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.7-3
- Update golang to 1.26.2

* Tue Mar 03 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.7-2
- Update golang to 1.25.7

* Thu Feb 05 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.7-1
- Update to 0.2.7

* Fri Jan 30 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.6-1
- Update to 0.2.6

* Thu Jan 22 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.5-1
- Update to 0.2.5

* Tue Jan 20 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.4-3
- Update to 0.2.4-3

* Fri Jan 16 2026 Jeremy Crafts <jcrafts@redhat.com> - 0.2.4-2
- Update to 0.2.4-2

* Mon Dec 22 2025 Jeremy Crafts <jcrafts@redhat.com> - 0.2.4-1
- Update to 0.2.4
